...
- Timestamp: `2022-06-07 05:33`
- Build ID: `59a71bab-694c-419c-a1d3-4b3e7a67fbea`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/59a71bab-694c-419c-a1d3-4b3e7a67fbea.git
$ cd 59a71bab-694c-419c-a1d3-4b3e7a67fbea
```
